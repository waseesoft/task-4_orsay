...
class OrsayCrawlSpider(CrawlSpider):
    name = "orsay_crawler"
    page_size = 72
    ...
    def parse(self, response):
        urls_s = response.css('.has-sub-menu[href$="produkte/"]+.js-menu-item-content a[href*="https://www.orsay.com/de-de/produkte/schuhe/"]')
        # urls_s = response.css('.has-sub-menu[href$="produkte/"]+.js-menu-item-content a')
        return [response.follow(url_s, callback=self.parse_pagination) for url_s in urls_s]
